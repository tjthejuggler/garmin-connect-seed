...
class NumberPickerView extends WatchUi.View {
    ...
    public function onUpdate(dc as Dc) as Void {
        ...
        if (WatchUi has :NumberPicker) {
            dc.drawText(centerX, (centerY - 5), Graphics.FONT_SMALL, "Press Menu Or Select", Graphics.TEXT_JUSTIFY_CENTER);
            ...
            dc.drawText(centerX, (centerY - 1), Graphics.FONT_SMALL, "NumberPicker not supported.", Graphics.TEXT_JUSTIFY_CENTER);
        }
    }
